    ...
    <div className="flex justify-center flex-row h-[calc(100%-56px)] bg-black">
      <div className="w-full max-w-[1280px] flex flex-col lg:flex-row">
        <div className="flex flex-col lg:w-[calc(100%-350px)] xl:w-[calc(100%-400px)] px-4 py-3 lg:py-6 overflow-y-auto">
          <div className="h-[200px] md:h-[400px] lg:h-[400px] xl:h-[550] ml-[-16px] lg:ml-0 mr-[-16px]">
            <ReactPlayer
        ...
        <div className="flex flex-col py-6 px-4 overflow-auto touch-pan-y lg:w-[350px] xl:w-[400px]">
          {relatedVideos?.contents?.map((items, index) => {
            if (items?.type !== "video") return false;
            return <SuggestionVideoCard video={items?.video} index={index} />;
          })}
        </div>
      </div>
    </div>
